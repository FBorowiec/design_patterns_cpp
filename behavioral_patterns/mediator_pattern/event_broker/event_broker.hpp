...
struct PlayerScoredData : EventData {
  PlayerScoredData(const std::string& player_name, const int goals_scored) : player_name_(player_name), goals_scored_(goals_scored) {}

  void Print() const override {
    std::cout << player_name_ << " has scored! (their " << goals_scored_ << " goal)\n";
  }
